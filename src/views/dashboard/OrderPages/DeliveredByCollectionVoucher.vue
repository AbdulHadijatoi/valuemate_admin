...
export default {
    ...
    methods: {
        async getData() {
          this.loading = true;
          try {
            const responseData = await fetchWrapper.post(`${base_url}/delivered-by-collection-voucher`, { 
        ...
        downloadCountsData() {
          ...
          XLSX.writeFile(workbook, 'delivered-by-collection-voucher-counts.xlsx');
        },
      ...
      <v-card variant="flat">
        <v-card-item>
          <div class="d-sm-flex align-center justify-space-between">
            <v-card-title>Delivered By Collection Voucher</v-card-title>
