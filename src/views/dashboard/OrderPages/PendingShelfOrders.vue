...
export default {
    ...
    methods: {
        async getData() {
          this.loading = true;
          try {
            const responseData = await fetchWrapper.post(`${base_url}/pending-shelf`, { 
        ...
        downloadCountsData() {
          ...
          XLSX.writeFile(workbook, 'pending-shelf-orders-counts.xlsx');
        },
      ...
      <v-card variant="flat">
        <v-card-item>
          <div class="d-sm-flex align-center justify-space-between">
            <v-card-title>Pending Shelf</v-card-title>
