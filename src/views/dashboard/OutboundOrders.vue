...
export default {
    ...
    methods: {
        async getCountsData() {
          this.loading = true;
          try {
            const responseData = await fetchWrapper.post(`${base_url}/outbound-orders/counts`, { 
        ...
        async getData() {
          ...
          this.loading = true;
          try {
            const responseData = await fetchWrapper.post(`${base_url}/outbound-orders`, { 
        ...
        downloadCountsData() {
          ...
          XLSX.writeFile(workbook, 'outbound-orders-counts.xlsx');
        },
      ...
      <v-card variant="flat">
        <v-card-item>
          <div class="d-sm-flex align-center justify-space-between">
            <v-card-title>Outbound </v-card-title>
