...
export default {
    ...
    methods: {
        async getCountsData() {
          this.loading = true;
          try {
            const responseData = await fetchWrapper.post(`${base_url}/delivered-orders/counts`, { 
        ...
        async getData() {
          ...
          this.loading = true;
          try {
            const responseData = await fetchWrapper.post(`${base_url}/delivered-orders`, { 
        ...
        downloadCountsData() {
          ...
          XLSX.writeFile(workbook, 'delivered-orders-counts.xlsx');
        },
