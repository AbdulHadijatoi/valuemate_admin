...
export default {
    ...
    methods: {
        async getCountsData() {
          this.loading = true;
          try {
            const responseData = await fetchWrapper.post(`${base_url}/inbound-orders/counts`, { 
        ...
        async getData() {
          ...
          this.loading = true;
          try {
            const responseData = await fetchWrapper.post(`${base_url}/inbound-orders`, { 
        ...
        downloadCountsData() {
          ...
          XLSX.writeFile(workbook, 'inbound-orders-counts.xlsx');
        },
      ...
      <v-card variant="flat">
        <v-card-item>
          <div class="d-sm-flex align-center justify-space-between">
            <v-card-title>Inbound </v-card-title>
